...
//  public static List<User> friends1 =
//	      new ArrayList<>(Arrays.asList(friends.get(0),friends.get(1),friends.get(2),friends.get(3)));
//  
  public static List<User> margelistFriends =
	      new ArrayList<>(Arrays.asList(friends.get(0),friends.get(1)));

  public static List<Message>Message = new ArrayList<>(Arrays.asList(new Message("bart@simpson.com","lisa@simpson.com","hello!!check")));
  
  public static List<Message> message =
	      new ArrayList<>(Arrays.asList(Message.get(0), Message.get(1),Message.get(2)));
}
