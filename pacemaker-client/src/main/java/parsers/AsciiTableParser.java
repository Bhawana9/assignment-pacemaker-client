...
public class AsciiTableParser extends Parser {
  ...
  public void renderdistanceActivities(Object distance) {
	    if (distance != null) {
	       {
...
//	    if (friends!= null) {
//	      if (!friends.isEmpty()) {
//	        List<User> friendList = new ArrayList(friends);
//	        IASCIITableAware asciiTableAware = new CollectionASCIITableAware<User>(friendList,
//	            "id","email");
//	        System.out.println(ASCIITable.getInstance().getTable(asciiTableAware));
//	      }
//	      System.out.println("ok");
...
public void renderMessages(Collection<Message>messages)
{
	if (messages != null) {
	      if (!messages.isEmpty()) 
	        {
	    	  List<Message> message = new ArrayList(messages);
	        IASCIITableAware asciiTableAware = new CollectionASCIITableAware<Message>(message,
	            "sender","recievr", "message");
	        System.out.println(ASCIITable.getInstance().getTable(asciiTableAware));
	      }
	      System.out.println("ok");
	    } else {
